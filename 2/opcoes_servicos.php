...
$cookieName = "servicos_oferecidos_".$categoriaId;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            optionsContainer.addEventListener('click', function (event) {
                ...
                if (clickedOption) {
                    ...
                    setTimeout(() => {
                        window.location.href = `opcoes2.php?codgrupo=<?php echo $_GET['grupo']; ?>&categoria=<?php echo $categoriaId; ?>&local=${encodeURIComponent(selectedOption)}`;
