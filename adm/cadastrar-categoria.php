...
if($_POST['acao']=="enviar") { 
    ...
    // Item 4: Mantém o filtro do grupo após salvar
    if (!empty($grupo)) {
        echo "<script> window.location.href='categorias/grupo/$grupo';</script>";
    } else {
        echo "<script> window.location.href='categorias';</script>";
    }
    exit;
}
?>
