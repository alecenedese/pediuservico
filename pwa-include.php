...
document.addEventListener('DOMContentLoaded', function() {
    ...
    nav.innerHTML = '<a href="meus-orcamentos-cli.php" class="nav-item' + (currentPage=='meus-orcamentos-cli.php' ? ' active' : '') + '"><span class="nav-icon">📋</span><span class="nav-label">Minhas Buscas</span></a>'
        + '<a href="buscar.php" class="nav-item' + (currentPage=='buscar.php' ? ' active' : '') + '"><span class="nav-icon">🔍</span><span class="nav-label">Buscar Prestador</span></a>'
        + '<a href="meus-orcamentos.php" class="nav-item' + (currentPage=='meus-orcamentos.php' ? ' active' : '') + '"><span class="nav-icon">🔧</span><span class="nav-label">Meus Serviços</span></a>';
